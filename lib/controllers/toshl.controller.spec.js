import { toshlAccounts, toshlCategories } from '../../test/helpers';
...
describe('controllers/toshl', function() {
    ...
    describe('getAccounts()', function() {
        ...
        it('should fail if there are too many requests', function(done) {
        ...
        it('should return the accounts if the personal token is valid', function(done) {
            ...
            this.requestGetStub
                .callsArgWith(1, null, { statusCode: httpCodes.OK, body: toshlAccounts }, toshlAccounts);

            toshlController
                .getAccounts(personalToken)
                .then(result => {
                    expect(result).to.be.an('array');
                    expect(result).to.be.lengthOf(toshlAccounts.length);
    ...
    describe('getCategories()', function() {
        ...
        it('should return the categories if the personal token is valid', function(done) {
            ...
            this.requestGetStub
                .callsArgWith(1, null, { statusCode: httpCodes.OK, body: toshlCategories }, toshlCategories);

            toshlController
                .getCategories(personalToken)
                .then(result => {
                    expect(result).to.be.an('array');
                    expect(result).to.be.lengthOf(toshlCategories.length);
